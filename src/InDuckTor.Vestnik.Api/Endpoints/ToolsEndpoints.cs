...
public static class ToolsEndpoints
{
    ...
    internal static async Task<JsonHttpResult<IMessageSender.BatchSendResult>> SendTestMessageToUser(int userId, VestnikDbContext dbContext, IMessageSender messageSender, CancellationToken ct)
    {
