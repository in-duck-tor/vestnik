const remote = "http://89.19.214.8/api/v1/ws/vestnik"
const local = "http://localhost:5057/api/v1/ws/vestnik"

const connection = new signalR.HubConnectionBuilder()
    .withUrl(`${remote}/account-events`, {
        accessTokenFactory: () => {
...
async function callSome() {
    await fetch(`${remote}/some?access_token=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..LsWmh_muuzuHA7fUI_7rgVCfDcC4pgrczV_LPL1U29rbTz2A6TCykVv70_gD73kas6a3bkPdu5uX0Q3oWpC4MjdYIODXOY8Er6TWULBH7ny38huTKJQy9O_VTl-A4wcG-KcCLilG_l4UDjchHV1__Ku0eD-ZtSUXb3fv7JjEfTGHz7oXPbmEEDzoVef3qd_jCqCvJ9O2qEFF5r8nIC-Q9wM5mpMDtQcnxtEi8iTDSjxKno-BIpLsY8TnYOOQ1Ci2WnEbU0uRmPwufDR2lZg8WKkvh1Ydh55DD_I82nI9a0KlPLExKTExlB0wUIvOE6Uhokq5-dKjmX_LJwXQhB0wyA`)
}
